---
title: "USDR Appointment Availability Data - Alaska"
...
* Slots outside working hours and in the weekend are available for a shorter amount of time.
...
For most indices, we see a **negative correlation between vulnerability and availability** (household SVI excluded), and the trend for `r S` is a bit worse than the national average (although appointments are generally available for longer).
