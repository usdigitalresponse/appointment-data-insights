---
title: "USDR Appointment Availability Data - New Jersey"
...
Most counties seem to have an approximately 15-20% coverage rate.
...
* weekend slots are booked at almost twice the rate of weekday slots
* there isn't much difference with respect to morning/day/evening times
* weekend and morning slots are available for less time, and you have to book them further in advance
...
* **Availability stats are very predictive of the number of vaccinations**, and explain a large amount of the variation. (_but the direction of the estimates is counter-intuitive_).
