...
* Most counties seem to have an approximately 25% coverage rate.
...
* **Availability stats are very predictive of the number of vaccinations**, and explain a large amount (about 10%) of the variation. Counter-intuitively, the number of weekend slots is not (or negatively) correlated with vaccination rates, which is different than the national trend.
