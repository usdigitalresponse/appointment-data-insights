...
stargazer::stargazer(
  ...
  lm(n_vax/population ~ p_black + hesitant + old_vax_rate, data=Dagg),
  lm(n_vax/population ~ slots_per_person_weekday + slots_per_person_weekend + avg_range + p_black + hesitant + old_vax_rate, data=Dagg),
  covariate.labels = c("Slots/Person (week)", "Slots/Person (weekend)", "Average range (hrs)", #"Average time ahead (hrs)",
                       "Share Black",  "% hesitant (CDC survey)", "Prior vax rate", "Intercept"),
